...
namespace emotitron.NST
{
	...
	public static class NetAdapterTools
	{
		...
		public static bool ChangeLibraries(NetworkLibrary newLib)
		{
			...
			Debug.LogWarning("dependenciesNeedToBeCheckedEverywhere being set to true");
			...
			Debug.LogWarning("dependenciesNeedToBeCheckedEverywhere being set to " + NetLibrarySettings.Single.dependenciesNeedToBeCheckedEverywhere);
		...
		public static bool PUN2_Exists
		{
			get
			{
				System.Type type = System.Type.GetType("Photon.Pun.PhotonNetwork");
				return type != null;
			}
		}
